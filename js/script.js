$(document).ready(function() {
    ...
    let countdownTimer;
    let timeRemaining = 40; // Automatic 40-second countdown for making a guess
...
let currentLevel = 1; // Variable to track the current level
    ...
    function startTimer() {
        ...
        if (currentGameType === 'definition') {
            if (currentLevel === 1) {
                timeRemaining = 80; // 80 seconds for Level 1
            } else if (currentLevel === 2) {
                timeRemaining = 70; // 70 seconds for Level 2
            } else if (currentLevel === 3) {
                timeRemaining = 60; // 60 seconds for Level 3
            }
        } else {
            timeRemaining = 40; // Default to 15 seconds for other games
        }
